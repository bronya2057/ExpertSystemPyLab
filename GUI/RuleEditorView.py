...
class Ui_RuleEditor(object):
    def setupUi(self, RuleEditor):
        ...
        self.textEdit = QtWidgets.QTextEdit(RuleEditor)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit.sizePolicy().hasHeightForWidth())
        self.textEdit.setSizePolicy(sizePolicy)
        self.textEdit.setMaximumSize(QtCore.QSize(1000, 30))
        ...
        self.tableViewRules = QtWidgets.QTableView(self.gBAllInfo)
        self.tableViewRules.setObjectName("tableViewRules")
        self.verticalLayout_2.addWidget(self.tableViewRules)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setContentsMargins(-1, 0, -1, -1)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lblRules = QtWidgets.QLabel(self.gBAllInfo)
        self.lblRules.setObjectName("lblRules")
        self.horizontalLayout_4.addWidget(self.lblRules)
        self.comboBox = QtWidgets.QComboBox(self.gBAllInfo)
        ...
        self.pbAddRule = QtWidgets.QPushButton(self.gBAllInfo)
        self.pbAddRule.setObjectName("pbAddRule")
        self.horizontalLayout_5.addWidget(self.pbAddRule)
        self.pbRenameRule = QtWidgets.QPushButton(self.gBAllInfo)
        self.pbRenameRule.setObjectName("pbRenameRule")
        self.horizontalLayout_5.addWidget(self.pbRenameRule)
        self.pushButton_3 = QtWidgets.QPushButton(self.gBAllInfo)
    ...
    def retranslateUi(self, RuleEditor):
        ...
        self.lblRules.setText(_translate("RuleEditor", "Rules:"))
        self.pbAddRule.setText(_translate("RuleEditor", "Add New Rule"))
        self.pbRenameRule.setText(_translate("RuleEditor", "Rename Selected Rule"))
        self.pushButton_3.setText(_translate("RuleEditor", "Remove Selected Rule"))
