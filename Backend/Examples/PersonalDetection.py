# Now the task is more complicated. We have app that should behave as personal dietican. We fill the number of
# calrioes and preference (Veg or Non-veg). After this program will tell us what we can eat for breakfast, lunch,
# snacks or dinner based on the previous information. Of course, content can be dynamic. You can for example have
# database or Knowledge Base of the meals and send querry while Rule is passed. You can also change the way how you
# give information for example to checkbox in case of preference or dropdown menus.
#
# Disclaimer I am not owner of those receipts. Those are copied from the internet and migh not be
from pyknow import *
